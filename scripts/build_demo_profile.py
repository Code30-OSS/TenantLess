...
the chain:
    ...
    profiles/oss-bootstrap.json        (hand-authored, synthetic)
      -> tenantless init-db            (provision synthetic schema 001..009)
...
def build() -> int:
    ...
    # (1) Provision synthetic schema 001..009 (idempotent). init-db is the ONLY
    ...
    print("[demo-build] (1) init-db -- provision synthetic schema 001..009")
    _cli(env, "init-db")
